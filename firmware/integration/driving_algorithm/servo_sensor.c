...
/** Array that store sensor values after processing, each values in this array is associated with one driving direction */
...
/** Array that store sensor values in front positions */
